...
'    Public Const Mysql_YGSP_ConStr As String = "Server=" & ServerAddress & ";Port=" & PortNo & ";Database=LIVE_YGSP;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
'    Public Const Mysql_QA_ConStr As String = "Server=" & ServerAddress & ";Port=" & PortNo & ";Database=LIVE_QA;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
'    Public Const Mysql_PMS_ConStr As String = "Server=" & ServerAddress & ";Port=" & PortNo & ";Database=LIVE_PMS;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
...
'    Public Const DocClient As String = "http://cpc475-tmlpc03.bh.me.ykgw.net/TML_FILE_MANAGER/"
'    Public Const StoreKey As String = "YKSASERVER_YKSA_DocsStore"
'    Public Const Api_MTC_Settings As String = "\SOFTWARES\LIVE SOFTWARES\COMMON\MTC_DATA\"
'    Public Const Api_CompleteDocumentFolder As String = "\Production Complete Documents"
'    Public Const Api_QIC_Template_Linear As String = "\Common Documents\Document Templates\xQicLinear.rpt"
'    Public Const Api_QIC_Template_Sqrt As String = "\Common Documents\Document Templates\xQicSquareRoot.rpt"
'    Public Const Api_QIC_Template_Linear9P As String = "\Common Documents\Document Templates\xQicLinear9P.rpt"
'    Public Const Api_QIC_Template_Recalibration As String = "\Common Documents\Document Templates\reCalibration.rpt"
'    Public Const Api_LTC_Template_N2 As String = "\Common Documents\Document Templates\PressureTest.rpt"
'    Public Const Api_LTC_Template_H2O As String = "\Common Documents\Document Templates\PressureTest_70MPa.rpt"
'    Public Const Api_LTC_Template_DPH2O As String = "\Common Documents\Document Templates\PressureTest_DP70MPa.rpt"
'    Public Const Api_MNFTC_Template_N2 As String = "\Common Documents\Document Templates\MNF_PressureTest.rpt"
'    Public Const Api_MNFTC_Template_H2O As String = "\Common Documents\Document Templates\PressureTest_70MPa.rpt"
'    Public Const Api_MTC_Template As String = "\Common Documents\Document Templates\MillCertificate_v01.rpt"
'    Public Const Api_DEVINFO_Template As String = "\Common Documents\Document Templates\Device_Info.xls"
'    Public Const Api_CrystallTemplateFolder As String = "\Common Documents\Document Templates\"
'    Public Const Api_OrderTagLocation As String = "\Production Release Documents\OrderTag\"
'    Public Const Api_PmiCertificatePath As String = "\Production Complete Documents\PMI_Certificates\"
'    Public Const Api_EvidenceImagePath As String = "\CV_Img_Repository\"
...
'    Public Const PortNo As String = "4600"
'    Public Const FE0_File As String = "Provider=Microsoft.Jet.Oledb.4.0;Data Source=$$$\FE0_YMA.mdb" 'Replace, $$$ with Application.StartupPath or As needed
'    Public Const Mysql_YGSP_ConStr As String = "Server=192.168.151.12;Port=4600;Database=LIVE_YGSP;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
'    Public Const Mysql_QA_ConStr As String = "Server=192.168.151.12;Port=4600;Database=LIVE_QA;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
'    Public Const Mysql_PMS_ConStr As String = "Server=" & ServerAddress & ";Port=" & PortNo & ";Database=LIVE_PMS;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
'    Public Const ServerDB As String = "LIVE_YGSP"
...
'    Public Const DocClient As String = "http://192.168.151.12/TML_FILE_MANAGER/"
'    Public Const StoreKey As String = "YKSASERVER_YKSA_DocsStore"
'    Public Const Api_MTC_Settings As String = "\SOFTWARES\LIVE SOFTWARES\COMMON\MTC_DATA\"
'    Public Const Api_CompleteDocumentFolder As String = "\Production Complete Documents"
'    Public Const Api_QIC_Template_Linear As String = "\Common Documents\Document Templates\xQicLinear.rpt"
...
'    Public Const DocClient As String = "http://cpc475-tmlpc04.bh.me.ykgw.net/TML_FILE_MANAGER/"
'    Public Const StoreKey As String = "YUAESERVER_YUAE_DocsStore"
'    Public Const Api_MTC_Settings As String = "\SOFTWARES\LIVE SOFTWARES\COMMON\MTC_DATA\"
'    Public Const Api_CompleteDocumentFolder As String = "\Production Complete Documents"
'    Public Const Api_QIC_Template_Linear As String = "\Common Documents\Document Templates\xQicLinear.rpt"
'    Public Const Api_QIC_Template_Sqrt As String = "\Common Documents\Document Templates\xQicSquareRoot.rpt"
...
Public NotInheritable Class Link
    ...
    Public Const PortNo As String = "4600"
    Public Const FE0_File As String = "Provider=Microsoft.Jet.Oledb.4.0;Data Source=$$$\FE0_YMA.mdb" 'Replace, $$$ with Application.StartupPath or As needed
    Public Const Mysql_YGSP_ConStr As String = "Server=" & ServerAddress & ";Port=4600;Database=LIVE_YGSP;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
    Public Const Mysql_QA_ConStr As String = "Server=" & ServerAddress & ";Port=4600;Database=LIVE_QA;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
    Public Const Mysql_PMS_ConStr As String = "Server=" & ServerAddress & ";Port=" & PortNo & ";Database=LIVE_PMS;Uid=PRDSCH;Pwd=LMLINE;CharSet=utf8;SslMode=Preferred;TlsVersion=TLS 1.2;"
    Public Const ServerDB As String = "LIVE_YGSP"
